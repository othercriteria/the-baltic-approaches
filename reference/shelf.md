...
| Holding | Status |
|---|---|
| Dupuy, *Numbers, Predictions and War* | print copy acquired 2026-07-20; **ARRIVED (in hand) 2026-07-25** — DK offers quick figure-reads/spot-checks, not full scanning; priority asks in planning/status.md standing reminders. Wanted for QJM structure (advance rates, OLI/CEV); attrition empirics covered publicly by the HERO handbook |
