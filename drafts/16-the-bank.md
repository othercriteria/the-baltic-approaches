...
The counterstroke force was built out of refusals, and
the refusals were read, two hundred kilometers up the
reporting chain, as decline.
...
serial numbers intact, a question from the political
level, which Witzel brought in without expression,
...
survived three relays intact) restore confidence in
...
theater's relaying voice, "and the record will carry
my assessment that confidence purchased at this
counter is dearer than the market knows. The
...
peninsula striking back. Militarily it bought a
...
one echelon less depth than the model had assumed,
and the wall posted the subtraction in the raid's own
after-action format, both times, without comment.

Loheide's worn regulars held the funnel's jaw. The
fresh force grew in the woods west of the canal:
...
where the ground said they must: through the evacuated
district. Assembly Point 14 — the Friedrichsberg
school, Column 217's school, four hundred meters from
the Roloff front door — took a brigade's forward
replenishment point, stores in the gymnasium, vehicles
under the plane trees the town had planted the year
the school was built. The report line for the northern
axis ran down a street where a boy of nine had learned
to ride a bicycle that October, wobbling, between his
father's hands. The line was designated by the bird-name
convention. Roloff inked it, both times on every
line, in the plain dialect, at his usual rate of work,
and brought the overlay for counter-signature at 0140.
...
THROUGH TOWN ALL WEEK. CHILDREN COUNTING FROM THE
SCHOOL FENCE, CURRENT TOTAL 214, DISPUTED. K SAYS THE
DISPUTED ONE WAS A RECOVERY VEHICLE. ALL WELL. EAT.

He read it twice, folded it into the notebook behind
the boxed pages, and went back to the operations room
...
opposite the narrows; radio silence broken twice, both
times by equipment serials, both times silenced
mid-transmission. And beneath the intercept, boxed,
